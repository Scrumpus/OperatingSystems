...
/**
     ...
     * Translate
     * 
     * translates a given virutal address to the physical address in RAM
     * @param virtAddr
     * @return physical address
     */
    private int translate(int virtAddr)
    { 	
    	int pageNum = virtAddr & m_pageMask;
    	pageNum = pageNum >> m_offsetSize;
    	
    	int frameNum = m_RAM.read(pageNum);
    	int offset = virtAddr & m_offsetMask;
    	
    	int physBase = frameNum << m_offsetSize;
    	
    	//return physical base and offset
